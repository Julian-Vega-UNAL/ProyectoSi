...
#Procesando Nivel
img = cv2.imread("Level\level.png", cv2.IMREAD_UNCHANGED)
img = cv2.cvtColor(img, cv2.COLOR_BGR2RGB)
cv2.imwrite("Level\level.png", img)
img = tf.keras.utils.load_img("Level\level.png", color_mode="grayscale")
...
region_img.save("Level\levelGray.png")
...
print(Matriz)
for i in objects:  
  level_img = cv2.imread('Level\levelGray.png', cv2.IMREAD_UNCHANGED)
  tile_img = cv2.imread(f'SetTemplates\TileTemplate{i[3]}.png', cv2.IMREAD_UNCHANGED)
